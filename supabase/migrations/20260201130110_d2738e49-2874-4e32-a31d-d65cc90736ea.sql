-- Update check_multiple_deposit_sources trigger: change threshold from 3 to 10 sources
...
BEGIN
  ...
  IF NEW.status = 'completed' AND OLD.status = 'pending' THEN
    ...
    -- If user has deposits from 10+ different sources in 24h, create a risk alert
